...
function error_curve_save(file_path, linear_errs, lrc_errs, ssl_errs, lrc_ssl_errs)
    ...
    plot(1:x_length, linear_errs, '-','LineWidth',1.5);
    hold on;
    plot(1:x_length, lrc_errs, '-','LineWidth',1.5);
    plot(1:x_length, ssl_errs, '-','LineWidth',1.5);
    plot(1:x_length, lrc_ssl_errs, '-','LineWidth',1.5);
